...
exports.logout = exports.signup = exports.checkPasswords = exports.login = void 0;
...
var checkPasswords = function checkPasswords(passwordInput, passwordConfirmInput) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Created account succesfully');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Successfully updated your ".concat(type === 'data' ? 'user data' : 'password'));
...
var stripe = Stripe('pk_test_iXx3iURpuWSVUNLgzoPKFmOu005SUpsZlk');
...
var filePicker = document.getElementById('photo');
...
if (filePicker) {
  filePicker.addEventListener('change', function () {
    var newPicker = document.getElementById('photo');
...
if (signupForm) {
  ...
  passwordConfirm.addEventListener('input', function (e) {
    ...
    var newPasswordConfirm = document.getElementById('password-confirm');
    (0, _auth.checkPasswords)(password, newPasswordConfirm);
  });
